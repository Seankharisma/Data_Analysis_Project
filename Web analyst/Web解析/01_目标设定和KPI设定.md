...
## KPI的设定
<P>将测定对象的指标做成KPI，不是那种单纯的增加和减少而是一定有具体的数值</P>

# 结合上述将其EC网站的KPI的设定一个具体例子展现

![EC网站KPI设计举例](https://github.com/Seankharisma/Data_Analysis_Project/blob/master/Web%20analyst/Web%E8%A7%A3%E6%9E%90/picture/ECwebsiteKPIsample.png)
