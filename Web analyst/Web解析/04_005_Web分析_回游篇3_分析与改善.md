...
通过tag manager的活动（event）功能的活用，设定在**tag manager的tag**可以进行开和关的控制。
</p>

![サイト内経路分析と改善点](https://github.com/Seankharisma/Data_Analysis_Project/blob/master/Web%20analyst/Web%E8%A7%A3%E6%9E%90/picture/Google_%20analytsis_event_tracking.png)
